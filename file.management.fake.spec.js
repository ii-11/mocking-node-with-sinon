...
describe("File Management Stub", () => {
  ...
  it("getAllFiles should return a list of files", () => {
    // we gotta define the behaviour immeditaly because fakes are immutable
  ...
  // fakes need to be replaced manually
  // fake must always exhibit the same behaviour
  // good for testing behaviour, but not state
});
